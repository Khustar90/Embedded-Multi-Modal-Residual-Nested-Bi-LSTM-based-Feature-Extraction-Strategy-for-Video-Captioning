...
input_folder = 'MSRVTT Dataset/videos'  # Replace with the path to your video folder
output_folder = 'key_frames/MSRVTT Dataset'  # Replace with the path to your desired output folder
...
input_folder = 'key_frames/MSRVTT Dataset'
images_output_file = 'Data/msrvtt_images.npy'
labels_output_file = 'Data/msrvtt_labels.npy'
...
#%%
"Audio Feature Extraction --------> VGG16"

from Audio_feature_Extractor import *

input_image = np.load("Data/msrvtt_images.npy")
Audio_feature = AFA()
...
features = extract_features_from_images(input_image, Audio_feature)
extracted_feature = np.array(features)

# Save predictions if needed
np.save("Data/msrvtt_AFE.npy", extracted_feature)
...
extracted_feature = np.load("Data/msrvtt_AFE.npy")
...
np.save("Data/msrvtt_fused_features.npy", fused_features)

print("Fused features have been saved.")
#%%

fusion = np.load("Data/msrvtt_fused_features.npy")
label = np.load("Data/msrvtt_labels.npy")
...
model.save("Model_Saved/Proposed_model_msrvtt.h5")
