...
# Define paths
video_path = 'MSRVTT Dataset/videos/video10.mp4'
frames_dir = 'MSRVTT Dataset/Frames'
txt_file_path = 'MSRVTT Dataset/caption/Annotation.txt'  
csv_file_path = 'MSRVTT Dataset/caption/annotations.csv'  
